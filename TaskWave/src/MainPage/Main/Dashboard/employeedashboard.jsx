                    ...
                    <div className="dash-info-list">
                      <div className="dash-card">
                        <div className="dash-card-container">
                          ...
                          <div className="dash-card-avatars">
                            <Link to="#" className="e-avatar"><img src={Avatar_04} alt="" /></Link>
                            <Link to="#" className="e-avatar"><img src={Avatar_08} alt="" /></Link>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="dash-info-list">
                      <div className="dash-card">
                        <div className="dash-card-container">
                          ...
                          <div className="dash-card-avatars">
                            <Link to="#" className="e-avatar"><img src={Avatar_05} alt="" /></Link>
                            <Link to="#" className="e-avatar"><img src={Avatar_07} alt="" /></Link>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <section>
                    ...
                    <div className="card">
                      <div className="card-body">
                        ...
                        <div className="request-btn">
                          <Link className="btn btn-primary" to="#">Apply Leave</Link>
                        </div>
                      </div>
                    </div>
                  </section>
                  <section>
                    ...
                    <div className="card">
                      <div className="card-body">
                        ...
                        <div className="request-btn">
                          <Link className="btn btn-primary" to="#">Apply Time Off</Link>
                        </div>
                      </div>
                    </div>
                  </section>
