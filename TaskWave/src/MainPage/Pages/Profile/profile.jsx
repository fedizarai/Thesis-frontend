...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    // Log the profileId to the console
    console.log('profileId 1:', profileId);

    // Optional: Handle the case where profileId might be undefined
    if (!profileId) {
      console.error('No profileId found in cookies');
    }
  }, []);
